...
def create_federated_zip(value):
  ...
  if length == 1:
    ...
    naming_fn = construct_naming_function(unnamed_zip.type_signature.member,
                                          names_to_add)
    return map_fn(naming_fn, unnamed_zip)
...
def construct_naming_function(tuple_type_to_name, names_to_add):
  ...
  Returns:
    ...
    `tuple_type_to_name`, `construct_naming_function` represents the identity.
